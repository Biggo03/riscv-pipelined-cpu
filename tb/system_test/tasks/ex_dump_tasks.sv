...
begin
    ...
    $fdisplay(reg_dump_handle, "      funct3: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.funct3);
    $fdisplay(reg_dump_handle, "      alu_control: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.alu_control);
    $fdisplay(reg_dump_handle, "      alu_src: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.alu_src);
    $fdisplay(reg_dump_handle, "      result_src: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.result_src);
    $fdisplay(reg_dump_handle, "      width_src: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.width_src);
    $fdisplay(reg_dump_handle, "      branch_op: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.branch_op);
    $fdisplay(reg_dump_handle, "      pc_base_src: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.pc_base_src);
    $fdisplay(reg_dump_handle, "      pc_src_pred: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.pc_src_pred);
    $fdisplay(reg_dump_handle, "      mem_write: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.mem_write);
    $fdisplay(reg_dump_handle, "      reg_write: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.reg_write);
    $fdisplay(reg_dump_handle, "      csr_control: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.csr_control);
    $fdisplay(reg_dump_handle, "      csr_we: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.csr_we);
    $fdisplay(reg_dump_handle, "      csr_src: 0x%h", `DATA_PATH_HIER.u_execute_stage.outputs_ex.control.csr_src);
end
endtask;
