...
begin
    ...
    $fdisplay(reg_dump_handle, "      result_src: 0x%h", `DATA_PATH_HIER.u_memory_stage.outputs_mem.control.result_src);
    $fdisplay(reg_dump_handle, "      width_src: 0x%h", `DATA_PATH_HIER.u_memory_stage.outputs_mem.control.width_src);
    $fdisplay(reg_dump_handle, "      mem_write: 0x%h", `DATA_PATH_HIER.u_memory_stage.outputs_mem.control.mem_write);
    $fdisplay(reg_dump_handle, "      reg_write: 0x%h", `DATA_PATH_HIER.u_memory_stage.outputs_mem.control.reg_write);
    $fdisplay(reg_dump_handle, "      csr_we: 0x%h", `DATA_PATH_HIER.u_memory_stage.outputs_mem.control.csr_we);
end
endtask;
